...
def fraction():
    ...
    instructionText = "Enter your answer as a fraction, i.e. two numbers separated by the / character.  Leave values as you first calculated them; don't simplify the fraction, e.g. enter 30/80."
