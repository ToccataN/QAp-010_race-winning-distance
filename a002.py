...
def fraction():
    ...
    instructionText = "Enter your answer in format separated by / character, i.e. numer/denom.  Leave values as you first calculated them; don't simplify the fraction, e.g. enter 30/80."
